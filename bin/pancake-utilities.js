  ...
  */
	error: function error(text) {
		...
		if (!Log.hasError) {
			...
			'Uh oh', 'Sorry', 'D\'oh', 'Oh my', 'Ouch', 'Oops', 'Nein', 'Mhh', 'Gosh', 'Gee', 'Goodness', 'Fiddlesticks', 'Dang', 'Dear me', 'Oh dear', 'Phew', 'Pardon', 'Whoops', 'Darn', 'Jinx', 'No luck', 'Cursed', 'Poppycock', 'Humbug', 'Hogwash', 'Boloney', 'Codswallop', 'Nuts', 'Foolery', 'Lunacy', 'Shenanigans', 'Fudge', 'Blimey', 'Dagnabit'];
